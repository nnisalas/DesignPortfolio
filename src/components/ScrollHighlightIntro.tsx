...
const TEXT_1 =
  "I'm a Product Designer & UX Researcher who uses systems thinking to turn complex problems into intuitive experiences grounded in research, interaction design, and behavioral psychology.";
const TEXT_2 =
